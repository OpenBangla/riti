...
pub(crate) const B_AA_KAR: char = '\u{09BE}';
pub(crate) const B_I_KAR: char = '\u{09BF}';
pub(crate) const B_II_KAR: char = '\u{09C0}';
pub(crate) const B_U_KAR: char = '\u{09C1}';
pub(crate) const B_UU_KAR: char = '\u{09C2}';
pub(crate) const B_RRI_KAR: char = '\u{09C3}'; // BENGALI VOWEL SIGN VOCALIC R
pub(crate) const B_VOCALIC_RR: char = '\u{09C4}'; // BENGALI VOWEL SIGN VOCALIC RR
pub(crate) const B_E_KAR: char = '\u{09C7}';
pub(crate) const B_OI_KAR: char = '\u{09C8}';

/* Two-part dependent vowel signs */
pub(crate) const B_O_KAR: char = '\u{09CB}';
pub(crate) const B_OU_KAR: char = '\u{09CC}'; // BENGALI VOWEL SIGN AU
